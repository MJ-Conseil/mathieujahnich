...
<div class="clipped--bottom flex-1  w-full md:pb-9 relative bg-blue-dark">
...
<main class="container md:p-0 md:0 md:mx-auto" id="main">
	<section class="my-4">
	...
	<section class="pb-8 md:p-8 p-4 bg-gray">
		<div class="lg:container h-full  lg:mx-auto">
			...
			<div class="h-full md:gap-x-20 md:gap-y-10 grid  md:grid-cols-3  items-center">
